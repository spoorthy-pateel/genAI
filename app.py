...
#     # Remove names (basic heuristic: "Firstname Lastname" format)
...
# # Step 4: Use Hugging Face model for NER
...
# def extract_skills_and_experience(text, entities):
#     skills_list = [
...
#     if matches:
#         print("Matches Found:", matches)  # Debugging: Print matches
#         return max(map(int, matches))  # Convert matches to integers and return the maximum value
#     else:
#         print("No Matches Found")  # Debugging: Print if no matches are found
...
# # Step 8: Process the resume
# # def process_resume_with_bert(pdf_path, job_description):
# #     raw_text = extract_text_from_pdf(pdf_path)
# #     cleaned_text = clean_text(raw_text)
# #     sanitized_text = remove_personal_details(cleaned_text)
# #     entities = extract_entities_with_bert(sanitized_text)
# #     skills, experience_sentences, date_ranges = extract_skills_and_experience(sanitized_text, entities)
...
#     # Extract certificates (if mentioned in the text)
#     certificates = extract_certificates(sanitized_text)
#     print("Extracted Certificates:\n", certificates) 
...
# #     pdf_path = "Palash-Agrawal-2000123558.pdf"  # Replace with the path to your PDF file
# #     job_description = """
# #     We are looking for a Java Developer with experience in application development using angular , AWS and spring boot 
# #     """
# #     extracted_info = process_resume_with_bert(pdf_path, job_description)
